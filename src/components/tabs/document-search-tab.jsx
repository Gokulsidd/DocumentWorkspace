            ...
            <TooltipProvider delayDuration={300}>
              ...
              >
                ...
                {showPlusMenu && (
                  <div
                    ref={menuRef}
                    className="absolute left-full  -top-1 bg-white rounded-xl shadow-lg border border-gray-200 p-1 flex items-center gap-1 z-50 animate-in fade-in zoom-in-95"
                    onMouseEnter={() => {
                      setMenuHovered(true);
              ...
              >
                <div className="relative group">
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <Button
                        onClick={(e) => handleSelectDocument(selectedDoc,e)}
                  ...
                  <div className="md:flex flex-col justify-center items-center gap-2">
                    {documents.slice(0, 10).map((doc) =>
                      selectedDocumentId != doc.id ? (
                        <div
                          key={doc.id}
                          onClick={(e) => handleSelectDocument(doc,e)}
                        >
                          <TooltipProvider>
                            <Tooltip>
                              <TooltipTrigger>
